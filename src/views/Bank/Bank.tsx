...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  if (bank.depositTokenName.startsWith("PHOENIX-AVAX")) {
    pairName = 'PHOENIX-AVAX pair';
    uniswapUrl = 'https://traderjoexyz.com/pool/AVAX/0x7a6e4e3cc2ac9924605dca4ba31d1831c84b44ae';
  } else if (bank.depositTokenName.startsWith("XSHARE-AVAX")) {
    pairName = 'XSHARE-AVAX pair';
    uniswapUrl = 'https://traderjoexyz.com/pool/AVAX/' + tshareAddr;
  } else {
    pairName = "PHOENIX-XSHARE pair";
    ...
    <Card>
      <CardContent>
        <StyledLink href={uniswapUrl} target="_blank">
          {`Provide or remove liquidity for ${pairName} on Traderjoexyz`}
        </StyledLink>
      </CardContent>
    </Card>
  );
