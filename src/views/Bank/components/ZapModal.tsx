...
const ZapModal: React.FC<ZapProps> = ({ onConfirm, onDismiss, tokenName = '', decimals = 18 }) => {
  ...
  return (
    <Modal>
      ...
      <StyledActionSpacer />
      <InputLabel style={{ color: '#c42a03' }} id="label">
      ...
      >
        ...
        <StyledMenuItem value={TSHARE_TICKER}>XSHARES</StyledMenuItem>
        {/* Tomb as an input for zapping will be disabled due to issues occuring with the Gatekeeper system */}
        <StyledMenuItem value={TOMB_TICKER}>PHOENIX</StyledMenuItem>
      </Select>
      <TokenInput
